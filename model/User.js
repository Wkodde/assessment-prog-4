...
class User {
    ...
    constructor(id, firstname, lastname, email, password) {
        ...
        try {
            ...
            assert(firstname.trim().length > 2, 'firstname moet minimaal 3 karakters lang zijn');
            assert(lastname.trim().length > 2, 'lastname moet minimaal 3 karakters lang zijn');
            ...
            assert(password.trim().length > 7, 'password moet minimaal 8 karakters lang zijn');
        }
        catch (ex) {
